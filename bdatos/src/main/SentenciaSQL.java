...
public class SentenciaSQL extends ConexionBD{
    ...
    public ArrayList<ProductoPublicacion> mostrarOfertasRecibidasDeUnaPublicacion(String idCuenta, int idPublicacion) {
    ...
    public ArrayList<ProductoPublicacion> buscarPublicacion(String idCuenta){
        ...
        String sql = "SELECT * FROM publicacion p INNER JOIN producto pro ON pro.idproducto = p.idpublicacion INNER JOIN categoria cat ON pro.idcategoria = cat.idcategoria"
                + " WHERE p.idcuenta NOT IN (?) and p.estadoPublicacion not in (1)";
    ...
    public ArrayList<ProductoPublicacion> obtenerPublicacionConOfertas(String idCuenta){
            ArrayList<ProductoPublicacion> resultado = new ArrayList<ProductoPublicacion>();
            PreparedStatement ps = null;
            establecerConexion();
            Connection con = getConexion();
