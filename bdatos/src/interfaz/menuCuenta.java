...
public class menuCuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl_detalleucu = new javax.swing.JLabel();
        ...
        p_init.add(txt_coin, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 460, 70, 30));
        ...
        p_init.add(btn_coin, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 460, -1, 30));
        ...
        p_init.add(lbl_detalleucu, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 340, 230, 100));
        ...
        p_init.add(btn_exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 720, 120, 30));
        ...
        p_init.add(lbl_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, -1, 30));

        lbl_user.setBackground(new java.awt.Color(0, 153, 255));
        lbl_user.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lbl_user.setText("Usuario");
        p_init.add(lbl_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 100, -1));
        ...
        p_init.add(txt_apellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, 230, 30));
        ...
        lbl_nombre.setBackground(new java.awt.Color(0, 153, 255));
        lbl_nombre.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lbl_nombre.setText("Nombre");
        p_init.add(lbl_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 260, 100, -1));
    ...
    private void btn_coinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_coinActionPerformed
        ...
        if(txt_coin.getText().isBlank()){
            JOptionPane.showMessageDialog(rootPane, "Es necesario ingresar datos","Error!", JOptionPane.ERROR_MESSAGE);
        }
        else{
            if(sql.cargarUCUCoins(cuenta, txt_coin.getText())){
               JOptionPane.showMessageDialog(null, "Acreditación correcta!");
           }else{
               JOptionPane.showMessageDialog(null, "Hubo un fallo en la acreditación, contacte a un administrador");
           }  
        }
